...
for(int i = 1; i < 7; i++) {
  ...
  hThetaP.add(new H2F("H2F_sec${i}_ThetaP", "#theta vs Momentum (sector ${i})", 1000, -180, 180, 1000, 0, 10))
}
hThetaPhi = new H2F("H2F_ThetaPhi", "#theta vs #phi", 1000, -180, 180, 1000, -180, 180)
